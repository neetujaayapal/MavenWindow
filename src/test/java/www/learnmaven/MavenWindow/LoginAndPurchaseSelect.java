...
public class LoginAndPurchaseSelect {
...
// confirm order		
		...
		WebElement orderPlacedMessageElement = driver.findElement(By.cssSelector("div#content h1"));// div#content h1
	...
	public void tearDown() {
     ...
     public Select select(WebElement country) {
